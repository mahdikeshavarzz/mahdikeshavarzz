      ...
      {!small ? (
                ...
                <Grid item className={classes.cardGridRootLeft}>
                  ...
                  >
                    ...
                    <b className={classes.b}>
                      HTML : <text style={{ color: "yellow" }}>70%</text>{" "}
                      {<br />} CSS :{" "}
                      <text style={{ color: "yellow" }}>80%</text> {<br />}
                      Bootstrap : <text style={{ color: "yellow" }}>
                        50%
                      </text>{" "}
                      {<br />}
                      JS : <text style={{ color: "yellow" }}>35%</text>
                      {<br />} ES6 :{" "}
                      <text style={{ color: "yellow" }}>50%</text> {<br />}{" "}
                      ReactJS :{" "}
        ...
        <Grid container className={classes.gridCardLeft}>
          <Grid item>
            <Card
              style={{ backgroundColor: "black" }}
              className={classes.smallCardRootLeft}
            >
              <CardContent>
                <Grid item className={classes.cardGridRootLeft}>
                  <Typography
